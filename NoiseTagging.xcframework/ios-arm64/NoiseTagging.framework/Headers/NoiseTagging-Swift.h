...
/// Pages can be List pages, which have sub pages where the user can navigate to; Settings pages, which provide automatically generated UI to edit settings (see <code>Setting</code>), or View pages, which simply provide a <code>UIView</code> to be displayed.
